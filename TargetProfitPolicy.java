...
public interface TargetProfitPolicy {
	 ...
	 * @throws UnreachableTargetProfitException : if the target profit cannot be reached 
	 */
	
	public abstract double meetTargetProfit (MyFoodora myFoodora, double targetProfit) throws UnreachableTargetProfitException;
